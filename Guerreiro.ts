import { Usuario } from "./Personagem";
import { Util } from "./Util";

export class Guerreiro extends Usuario {
  ...
  private ataque(oponente: Usuario): void {
